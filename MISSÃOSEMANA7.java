...
public class MISSÃOSEMANA7 {
    ...
    public static void main(String[] args) {
        ...
        Scanner console = new Scanner(System.in); //Inicializa primeiro Scanner o qual lê float
        Scanner console2 = new Scanner(System.in); //Inicializa segundo Scanner o qual lê string
        ...
        while (continuar == 's' || continuar == 'S') { //Se variavel lida for S minusculo ou maiusculo realiza o looping
            ...
            String nome1 = console2.nextLine(); //Atribui informação passada pelo usuario a variavel
            System.out.print("Insira o sobrenome do empregado 1: "); //Solicita o sobrenome do empregado 1
            String sobrenome1 = console2.nextLine(); //Atribui informação passada pelo usuario a variavel
            ...
            System.out.print("Insira o nome do empregado 2: "); //Solicita o nome do empregado 2
            String nome2 = console2.nextLine(); //Atribui informação passada pelo usuario a variavel
            System.out.print("Insira o sobrenome do empregado 2: "); //Solicita o sobrenome do empregado 2
            String sobrenome2 = console2.nextLine(); //Atribui informação passada pelo usuario a variavel
